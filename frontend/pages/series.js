      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-2">
        <div>
          ...
          <div className="flex gap-2 text-xs items-center">
            ...
            <span>•</span>
            <span>
              {serie.seasons} saison{serie.seasons > 1 ? "s" : ""}
            </span>
            {serie.isClassic && (
    ...
    const fetchSeries = async () => {
      try {
        ...
        const formattedData = data.map((serie) => ({
          ...
          isClassic:
            CLASSIC_SERIES.includes(serie.title) || Boolean(serie.isClassic),
        ...
        const featured =
          formattedData.find((s) => s.isFeatured) ||
          formattedData.find((s) => s.title === "Prison Break") ||
          formattedData[0];
                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-lg font-semibold mb-2">
                        À propos de {selectedSerie.title}
                      </h3>
                      <p className="text-gray-300">
                        {selectedSerie.detailed_description ||
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div>
                        ...
                        <p className="text-gray-300">
                          {selectedSerie.actors?.join(", ") || "Non disponible"}
                        </p>
                      </div>
                      <div>
        ...
        <div className="relative z-20 h-full flex flex-col justify-center pb-32 px-8">
          <div className="max-w-2xl">
            ...
            <div className="flex gap-4 mb-4 text-lg">
              ...
              <span>
                {featuredSerie.seasons} saison
                {featuredSerie.seasons > 1 ? "s" : ""}
              </span>
              {featuredSerie.isClassic && (
                <span className="text-yellow-400">⭐ Culte</span>
              )}
